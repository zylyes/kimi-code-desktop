> 来源: https://www.kimi.com/code/docs/kimi-code-cli/guides/sessions.html
...
- [数据路径](kimi-code-cli/configuration/data-locations.md) — 会话文件的完整目录结构说明
- [kimi 命令](kimi-code-cli/reference/kimi-command.md) — `--continue`、`--session`、`export` 等命令的完整参数参考
